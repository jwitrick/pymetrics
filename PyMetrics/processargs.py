...
class ProcessArgs( object ):
    ...
    def __init__( self,
        ...
        parser.add_option('--html',
                          action='store_true',
                          dest='htmloutput',
                          default=self.genHTMLSw,
                          help='Write the output to HTML files. (Default is %s)'%self.genHTMLSw)
        parser.add_option('--html-dir',
                          dest='htmloutput_dir',
                          default=self.htmldir,
                          help='Write the output to HTML files to this directory. (Default is %s)'%self.htmldir)
        parser.add_option('--html-file',
                          dest='htmloutput_file',
                          default=self.htmlfile,
                          help='Write html to this file. (Default is %s)'%self.htmlfile)
        ...
        if self.genHTMLSw:
            try:
                mode = 'w'
                #html = open( os.path.join(self.htmloutput_dir, self.htmloutput_file), mode)
                
            except StandardError,e:
                sys.stderr.writelines( str(e) + "--No HTML files will be generaged\n\n" )
                html = None
